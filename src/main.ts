...
const footerDonationsEl = document.getElementById("footer-donations") as HTMLAnchorElement | null;
...
if (footerDonationsEl) footerDonationsEl.href = MEEKER_DONATIONS_URL;
